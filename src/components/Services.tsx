...
<section id="services" className="bg-white dark:bg-gray-950 py-20"> 
    <div data-aos="fade-up" className="container mx-auto px-4"> {/* Section Header */} <div data-aos="fade-up" className="text-center mb-16 max-w-2xl mx-auto"> <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-4"> Our Services </h2> <p className="text-gray-600 dark:text-gray-400 text-lg"> Empowering growth across Crypto, Agriculture, and Real Estate through trusted and innovative solutions. </p> </div>
    {/* Services Grid */}
    <div data-aos="fade-up" className="grid gap-10 sm:grid-cols-2 lg:grid-cols-3">
      {services.map((service, index) => (
        <div data-aos="fade-up"
          key={index}
          className="group bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 p-8 shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300"
        >
          <div data-aos="fade-up" className="mb-4 flex justify-center">{service.icon}</div>
          <h4 className="text-xl font-semibold text-gray-800 dark:text-white text-center mb-3">
            {service.title}
          </h4>
