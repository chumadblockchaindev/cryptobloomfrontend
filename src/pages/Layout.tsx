    ...
    <footer className="bg-gray-900 text-gray-200 pt-12 pb-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div>
              ...
              <form action="forms/newsletter.php" method="post" className="flex flex-col space-y-3">
                ...
                <div className="loading text-sm text-gray-400">Loading...</div>
                <div className="error-message text-sm text-red-500"></div>
                <div className="sent-message text-sm text-green-500">Thank you for subscribing!</div>
              </form>
            </div>
          </div>
          ...
          <div className="mt-12 border-t border-gray-700 pt-6 text-center text-sm text-gray-500">
            ...
            <p className="mt-1">
              Designed by <a href="#" className="text-indigo-400 hover:underline">Chumatech</a>
            </p>
          </div>
        </div>
      </footer>
