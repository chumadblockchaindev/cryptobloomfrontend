            ...
            {selectedWallet && (
                <div>
                    <p className="font-medium mb-4">
                        Send <span className="text-red-700">${state.amount}</span> to the wallet address below in the {selectedCoin} Network. Any coin sent to a different network will be lost.
                    </p>
